            ...
            <div key={employee.id} className="gx-media gx-task-list-item gx-flex-nowrap">
              ...
              <div className="gx-media-body gx-task-item-content">
                <div className="gx-task-item-content-left">
                  <h5
                    className="gx-text-truncate gx-task-item-title">{employee.staff_name}</h5>
                  ...
                  <span
                    className="gx-text-grey gx-fs-sm gx-mb-0">{employee.resolved_tickets_count + " " + "resolved"}</span>
                </div>
