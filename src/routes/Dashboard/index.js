...
class Dashboard extends Component {
    ...
    render() {
        const {totalTickets, totalStaff, totalCustomers, ticketsList, priorityList, recentCustomers,
            topStaff, staticsData, pendingTickets, newTickets, newCustomers} = this.props;
        return (
...
const mapStateToProps = ({dashboard}) => {
    const {totalTickets, totalStaff, totalCustomers, ticketsList, priorityList, recentCustomers,
        topStaff, staticsData, pendingTickets, newTickets, newCustomers} = dashboard;
    return {
        totalTickets,
        totalStaff,
        totalCustomers,
