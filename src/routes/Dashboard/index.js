...
import ChartCard from "./Tickets/ChartCard";
import RecentCustomers from "./Tickets/RecentCustomers";
import SupportStaff from "./Tickets/SupportStaff";
import Statistics from "./Tickets/Statistics";
import TicketData from "./Tickets/TicketData";
  ...
  return (
    <div>
      ...
      <TicketListing />
        ...
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <TicketData prize="2937" title="+2.5" icon="bitcoin"
                     children={<ResponsiveContainer width="100%" height={50}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
                         <defs>
        ...
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <TicketData prize="27" title="+2.5" icon="etherium"
                     children={<ResponsiveContainer width="100%" height={50}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
        ...
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <TicketData prize="2910" title="-0.5" icon="ripple"
                     children={<ResponsiveContainer width="100%" height={50}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
        ...
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <TicketData prize="122"  icon="etherium"
                     children={<ResponsiveContainer width="100%" height={50}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
