...
import {Avatar, Breadcrumb, Button, Dropdown, Icon, Input, Menu, message, Modal, Popconfirm, Select, Table} from "antd";
import Widget from "../../../components/Widget";
import {Link} from "react-router-dom";
import AddNewCompany from "./AddNewCompany";
import {connect} from "react-redux";
import {
  onAddNewCompany, onAddProfileImage,
  onDeleteCompanies,
  onEditCompany,
  onGetCompaniesData
...
class Companies extends Component {
        ...
        render: (text, record) => {
          return (<div className="gx-media gx-flex-nowrap gx-align-items-center">
            {record.attachment ?
              ...
              <Avatar className="gx-mr-3 gx-size-80" style={{  backgroundColor: '#f56a00' }}>{record.company_name[0]}</Avatar>}
      ...
      <Menu>
        ...
        <Menu.Item key="4">
          <Popconfirm
            ...
            onConfirm={() => {
              this.props.onDeleteCompanies({ids: [companyId]}, this.onDeleteSuccessMessage,
  ...
  onDeleteSuccessMessage = () => {
    message.success('The selected Company(s) has been deleted successfully.');
  };
    ...
    if (this.state.selectedCompanies.length !== 0) {
      confirm({
        ...
        onOk: () => {
          ...
          this.props.onDeleteCompanies(obj, this.onDeleteSuccessMessage,
            this.props.onGetCompaniesData, this.state.current,this.state.itemNumbers);
